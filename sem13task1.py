from sem13task1 import RectangleWorks
from sem13task1 import MatrixWorks
from sem13task1 import FileListerWorks
from sem13task1.task_02.custom_exceptions import *
...
def file_lister_part():
    start_path = '/Users/elena/OneDrive/Рабочий стол/GB'
    wrong_path = 'Documents/geekbrains/Python2023/Homeworks/sem13task1'
    try:
